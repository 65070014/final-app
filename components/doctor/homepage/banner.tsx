...
export default function Banner() {
    return (
        <div className="grid md:grid-cols-5 gap-6 p-4">
            ...
            <div className="md:col-span-3 bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-2xl flex items-center justify-center">
                <div className="grid grid-cols-2 gap-4 w-full">
                    {menuItems.map((item) => (
                        <Link href={item.href} key={item.label}>
                            <div className="group p-6 border dark:border-gray-700 rounded-xl hover:bg-blue-50 dark:hover:bg-gray-700 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer flex flex-col items-center justify-center h-full">
