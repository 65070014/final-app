    ...
    return (
        <div className="min-h-screen p-4 sm:p-8 bg-blue-400 text-black font-sans">
            <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-xl p-6">
                ...
                <AppointmentCalendar appointments={appointments} deleteAppointment={deleteAppointment} confirmAppointment={confirmAppointment} handleReschedule={handleReschedule} currentDate={currentDate} type="nurse" />
            </div>
        </div>
    )
}